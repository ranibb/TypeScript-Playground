...
async-await pattern. For that define a function printFileConent and add the "async" keyword in front of the
...
async function printFileConent(filename){
    try {
